...
time = 30
[Command]
name = "especial devastador"
command = ~D, DF, F, B, a
time = 30
[Command]
name = "especial devastador2"
command = ~D, DF, F, B, x
time = 30
[Command]
name = "especial devastadorssj2"
command = ~D, DB, B, F, z
time = 30
[Command]
name = "ssj2magias"
...
time = 30
[Command]
name = "especial devastadorssj22"
command = ~D, DB, B, F, c
time = 30
[Command]
name = "camehameha que desaparece"
command = D, DB, B, F, x
time = 30
;==============================sequencias================================
[Command]
name = "sequencia de porradas"
command = D, DF, F, z
time = 10
[Command]
name = "super energia"
...
type = ChangeState
value = 160095
triggerall = command = "trunks fica nervoso"
...
value = 1390989
triggerall = var(5) = 1
triggerall = command =  "magiaR3xssj2"
...
value = 7000
triggerall = var(5) = 1
triggerall = command = "camehameha que desaparece"
trigger1 = statetype = S && Ctrl && power >= 1000
[State -1]
type = ChangeState
value = 2600
triggerall = var (5) = 0
triggerall = command = "super energia"
...
type = ChangeState
value = 87479
triggerall = command = "sequencia de porradas"
trigger1 = statetype = S
trigger1 = ctrl = 1
...
value = 1060989
triggerall = var (5) = 1
triggerall = command ="5hits rapidos"
trigger1 = statetype = S
trigger1 = ctrl = 1
[State -1]
type = ChangeState
...
value = 1020989
triggerall = var (5) = 1
triggerall = command = "super atropelo"
triggerall = power >= 0
trigger1 = statetype = S
trigger1 = ctrl
...
value = 360989
triggerall = var (5) = 1
triggerall = command = "sequenciahit"
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2 = stateno = 11500
[State -1]
...
value = 350989
triggerall = var (5) = 1
triggerall = command = "sequenciaflash"
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2 = stateno = 11500
[State -1]
...
value = 700989
triggerall = var (5) = 1
triggerall = command = "campo de força"
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = stateno = 11500
[State -1]
...
value = 7800989
triggerall = var (5) = 1
triggerall = command = "especial devastadorssj22"
...
value = 4010989
triggerall = var (5) = 1
triggerall = command = "especial devastadorssj2"
triggerall = power >= 3000
triggerall = numproj = 0
trigger1 = ctrl = 1
trigger1 = statetype != A
...
value = 2500
triggerall = var (5) = 1
triggerall = command = "kamehamehassj2"
triggerall = numproj = 0
...
type = ChangeState
value = 1900
triggerall = command = "masenko fraco"
triggerall = numproj = 0
...
type = ChangeState
value = 1055
triggerall = command = "bolas rapidas"
triggerall = numproj = 0
trigger1 = statetype != A
trigger1 = ctrl = 1
trigger2 = stateno = 1500
...
type = ChangeState
value = 4010
triggerall = command = "especial devastador"
triggerall = power >= 3000
triggerall = numproj = 0
trigger1 = ctrl = 1
trigger1 = statetype != A
...
type = ChangeState
value = 7800
triggerall = command = "especial devastador2"
triggerall = power >= 2000
triggerall = numproj = 0
trigger1 = ctrl = 1
trigger1 = statetype != A
