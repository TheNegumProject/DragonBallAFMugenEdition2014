;moves for Majin Vegeta SSJ3 UB22
;by OCariocanildo
...
trigger7 = movecontact = 1
;---------------------------------------------------------------------------
;Especial Super Sayjins
[State -1]
type = ChangeState
value = 1510
triggerall = command = "especial3";Place name of command here
...
;---------------------------------------------------------------------------
;Especial Super Sayjins (Vegeta)
[State -1]
type = ChangeState
value = 1520
triggerall = command = "especial4";Place name of command here
;triggerall = command != "holddown";Standing moves should have this line
 ;The following is true if Player is in stand state, and has control
