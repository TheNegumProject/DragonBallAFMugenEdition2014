...
value = 1905
trigger1 = command = "Big_Bang_Attack";-------
trigger1 = statetype = A
trigger1 = ctrl = 1
trigger2 = command = "Big_Bang_Attack";-------
trigger2 = stateno = 600        ;jump_a
trigger3 = command = "Big_Bang_Attack";-------
trigger3 = stateno = 610        ;jump_b
trigger3 = MoveContact
trigger4 = command = "Big_Bang_Attack";-------
trigger4 = stateno = 800        ;jump_fwd_a
trigger4 = MoveContact
;trigger5 = command = "Big_Bang_Attack";-------
;trigger5 = stateno = 1031        ;uppercut_b2
;trigger5 = MoveContact
;trigger6 = command = "Big_Bang_Attack";-------
;trigger6 = stateno = 1051        ;flykick_b2
;trigger6 = MoveContact
;trigger7 = command = "Big_Bang_Attack";-------
;trigger7 = stateno = 1070        ;airflykick_b
;trigger7 = MoveContact
;---------------------------------------------------------------------------
; Big Bang Attack State
[State -1]
type = ChangeState
value = 1900
